...
$query="update  userRegistration set Name=?,Emailid=?,contactNo=?,City=?,Address=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssssisi',$name,$emailid,$contactno,$city,$address);
...
<div class="col-sm-8">
<input type="text" name="name" id="name"  class="form-control" value="<?php echo $row->firstName;?>"   required="required" >
</div>
</div>
